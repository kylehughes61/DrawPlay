...
public class Cat {
	...
	private static final int MOUTH_X = HEAD_DIMENSION/4 +15;
	private static final int MOUTH_Y = HEAD_DIMENSION/6 * 3 + 15;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		// Draw the eyes
		Color colour = new Color(33, 160, 10);
		g2.setColor(colour);
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		...
		g2.drawString("I AM CAT!!", catX, catY+HEAD_DIMENSION+10);	
	}
}
